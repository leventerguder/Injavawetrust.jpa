...
public class EmployeeTest {
	...
	public static void main(String[] args) {
		...
		Employee4 employee = employeeService.createEmployee(1, "Levent", "Erguder", 1000,"555 000 00 00");
		Employee4 employee2 = employeeService.createEmployee(2, "James", "Gosling", 10000,"200 400 50");
		Employee4 employee3 = employeeService.createEmployee(3, "Joshua", "Bloch", 10000,"300 500 70");
